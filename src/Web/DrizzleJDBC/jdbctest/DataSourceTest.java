...
public class DataSourceTest 
{
    ...
    public void testJaguarDataSource( String ports ) throws SQLException 
	{
		...
		// statement.executeUpdate("update jon1 set m1='ssss' where uid='000QG02jVc0iKP8QyfMGcz8LQ6UjdMDd';");

		ResultSet rs = statement.executeQuery("select * from jbench limit 10;");
		...
		while(rs.next()) {
			...
			System.out.println( "uid: " + val + " m1: " + m1 + " addr: " + addr  );
		}
